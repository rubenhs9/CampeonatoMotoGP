...
public class panelAltasEscuderias extends javax.swing.JPanel {
    ...
    public panelAltasEscuderias(JPanel panelPrincipal, JPanel panelOpciones, Campeonato campeonato, Color colorPrimario) {
    ...
    private void botonVolverAtras(){
        ...
        volverAtras.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                panelPrincipal.remove(panelAltasEscuderias.this);
    ...
    private void minitComponents() {
        ...
        for (Escuderia escuderia : campeonato.getEscuderias()) {
            ...
            labelEscuderia.addMouseListener(new MouseAdapter() {
                @Override
                public void mouseClicked(MouseEvent e) {
                    panelAltasPilotos panelAltasPilotos = new panelAltasPilotos(panelPrincipal, panelAltasEscuderias.this, campeonato,escuderia, colorPrimario);
                    panelPrincipal.remove(panelAltasEscuderias.this);
