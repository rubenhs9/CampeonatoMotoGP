...
public class panelImportarXML extends javax.swing.JPanel {
    ...
    public panelImportarXML(JPanel panelPrincipal, JPanel panelAnterior, Campeonato campeonato, Color colorPrimario) {
    ...
    private void botonVolverAtras(){
        ...
        volverAtras.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent e) {
                panelPrincipal.remove(panelImportarXML.this);
